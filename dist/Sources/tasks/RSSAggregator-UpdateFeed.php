...
class RSSAggregator_Background extends SMF_BackgroundTask
{
	...
	private function format_post_body($updates)
	{
		...
		// LOTS & LOTS of cleanup and formatting here, before posting.
		...
		// Finally, some of these are huge, truncate anything that won't fit...
		// When truncating, leave plenty of headroom...  Seems to expand quite a bit between here & the actual physical insert...
		$post_body = mb_substr($smcFunc['htmlspecialchars']($post_body), 0, 64000);
